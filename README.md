...
동시에 칵테일에 대한 수요도 증가하여 우리 서비스는 칵테일을 집에서도 즐기는 '온라인 칵테일 바'를 만들고자 합니다.

### 📗  국제 바텐더 협회 데이터 사용

국제 바텐더 협회(IBA)에서 제공하는 데이터를 사용하여 신뢰성 있는 레시피를 제공하고자 합니다.<br/> 
칵테일 종류, 주조법, 필요한 재료에 대한 정보를 제공해 줍니다.
